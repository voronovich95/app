...
В качестве CI/CD используется инструмент Jenkins, который в свою очередь контролирует репозиторий
с страничкой Hello World, и при изменении осуществляет сборку docker image и перезапуск контейнера 
в соответствии с измененным Dockerfile. 
```
